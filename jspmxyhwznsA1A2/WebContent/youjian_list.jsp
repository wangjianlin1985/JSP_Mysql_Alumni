...
<!--hxsglxiangdxongjxs-->
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='youjian_listxls.jsp';" />
</form>
...
//txixixngdy
    ...
    String url = "youjian_list.jsp?1=1"; 
    String sql =  "select * from youjian where 1=1";
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="youjian_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="youjian_list.jsp?scid=<%=map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
