...
<body style="margin: 0; border: 0;">
        ...
        <div class="main" id="menua">
			...
			<h3 menuid="1"  id="menu1" onclick="showsubmenu(1)" toggleGroup="on" class="menutitle"><div class="bt1"><span>个人资料管理</span></div></h3>
				<ul id="submenu1">
					<li><a href="yonghuzhuce_updt2.jsp" target="frmright">个人资料管理</a></li>
					<li><a href="mod2.jsp" target="frmright">修改密码</a></li>
				</ul>

           <!-- <h3 menuid="2"  id="menu2" onclick="showsubmenu(2)" toggleGroup="on" class="menutitle"><div class="bt2"><span>入会任职信息</span></div></h3>
				<ul id="submenu2">
					<li><a href="ruhuijilu_list2.jsp" target="frmright">入会任职信息</a></li>
				</ul>
			
			<h3 menuid="3"  id="menu3" onclick="showsubmenu(3)" toggleGroup="on" class="menutitle"><div class="bt3"><span>班级信息管理</span></div></h3>
				<ul id="submenu3">
					<li><a href="banjixinxi_add.jsp" target="frmright">班级信息添加</a></li>
					<li><a href="banjixinxi_list2.jsp" target="frmright">我的班级信息</a></li>
				</ul>
			
			<h3 menuid="4"  id="menu4" onclick="showsubmenu(4)" toggleGroup="on" class="menutitle"><div class="bt4"><span>班级通讯录管理</span></div></h3>
				<ul id="submenu4">
					<li><a href="banjitongxunlu_add.jsp" target="frmright">班级通讯录添加</a></li>
					<li><a href="banjitongxunlu_list2.jsp" target="frmright">我的班级通讯录</a></li>
				</ul>-->
				
			<h3 menuid="5"  id="menu5" onclick="showsubmenu(5)" togglegroup="on" class="menutitle"><div class="bt5"><span>站内信管理</span></div></h3>
				<ul id="submenu5">
			...
			<h3 menuid="6"  id="menu6" onclick="showsubmenu(6)" toggleGroup="on" class="menutitle"><div class="bt6"><span>论坛帖子管理</span></div></h3>
				<ul id="submenu6">
					<li><a href="tiezi_list2.jsp" target="frmright">我的帖子管理</a></li>
				</ul>
	...
	<!--		<h3 menuid="7"  id="menu7" onclick="showsubmenu(7)" togglegroup="on" class="menutitle"><div class="bt7"><span>校园动态管理</span></div></h3>
			...
			<h3 menuid="18"  id="menu18" onclick="showsubmenu(18)" toggleGroup="on" class="menutitle"><div class="bt8"><span>系统管理</span></div></h3>
				<ul id="submenu18">
					<li><a href="database.jsp" target="frmright">数据备份</a></li>
