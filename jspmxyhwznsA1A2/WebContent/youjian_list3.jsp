...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="138" align="center" bgcolor="CCFFFF">发送者权限</td>
...
//txixixngdy
    ...
    String sql =  "select * from youjian where jieshouzhe='"+request.getSession().getAttribute("username")+"' ";
...
//youzuiping2
 ...
 <td><%=map.get("fasongzhe") %></td>
    ...
    <td width="138" align="center"><%=map.get("cx") %></td>
    <td width="138" align="center"><%=map.get("addtime") %></td>
    <td width="60" align="center"><a href="youjian_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="youjian_list3.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <!--qiatnalijne--> </td>
  </tr>
  	<%
  }
   %>
